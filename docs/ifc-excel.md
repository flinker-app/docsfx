...
description: Learn how to extract IFC model data into Excel, keep Excel Online workbooks synchronized, and use Microsoft 365 for analysis and reporting.
...
2. Open the SharePoint location of the generated workbook:

![Find your IFC Excel Online Synchronization](/_media/find-your-ifc-excel-online-synchronization.png)

3. Continue the analysis in Excel. Add formatting, pivot tables, charts, calculations, or Power BI connections.
...
4. Share the synchronized Excel workbook with colleagues, teams, or Microsoft Teams channels:
...
### Is a new Excel Online link created for each query?
