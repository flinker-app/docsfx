---
title: Connect IFC data from Excel to Power BI
...
# Connect IFC data from Excel to Power BI
...
### 2. Open the Excel file location
...
### 5. Choose Excel as the data source
...
![In Power BI: Paste direct Excel file link and select your organizational account to sign in](/_media/in-power-bi-app-paste-direct-excel-file-link-and-select-organization-account-to-sign-in.png)
