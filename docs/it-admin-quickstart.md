...
| IFC Viewer Visual for Power BI | Display IFC models inside Microsoft Power BI reports with a custom visual. | Fabric Administrator adds the visual to organizational visuals or allows report creators to add it from AppSource through tenant settings. [Deployment guide](./ifc-viewer-installation-for-power-bi.md) |
