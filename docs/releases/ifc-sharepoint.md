...
* Use the Viewer SDK for SharePoint file loading
* Load viewer models faster
* Support additional viewer file formats: IFCZIP, BCFZIP and DXF
* Remove licensing gates
