...
2. Now you have two options:
    - Select **Enable and Add** to approve the app and add it to all sites automatically.
...
3. Select the three dots (**...**) next to the selected item to open the context menu.
